export default async function handler(req, res) {
  ...
  // IDs das coleções (data sources) — não os IDs dos databases
  const DS_POSTS     = '1b4cfb56-0096-8100-b56b-000b9dd3ca89';
  const DS_METRICAS  = 'e0844cae293e45f7a67085e1be87bdfd';
  ...
  try {
    if (tipo === 'posts') {
      const filter = { property: 'Status', status: { equals: 'Aprovado e agendado' } };
